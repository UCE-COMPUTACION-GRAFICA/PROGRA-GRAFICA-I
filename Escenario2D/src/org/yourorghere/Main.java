...
public class Main extends JFrame implements GLEventListener, KeyListener {
    ...
    boolean autoderecha = false;
    boolean autoizquierda=false;
    ...
    public class GraphicListener
        ...
        public void display(GLAutoDrawable drawable) {
            ...
            //persona
            gl.glPushMatrix();
            //gl.glRotatef(count, 0, 1, 0);
            gl.glTranslatef(-30, 5, 0);
            per.persona();
            gl.glPopMatrix();
           ...
           //au.auto();
            ...
            //System.out.println("contad"+count);
            count = (float) (count + 0.01f);
