        ...
        GLU glu= new GLU ();     
           ...
           glu.gluLookAt(t.x+2+Teclado.getTrasladaX(),t.y+2+Teclado.getTrasladaY(),t.z+2,t.x,t.y,t.z,0,1,0);}
             ...
             if(ncam==5){
                ...
                //sigue al objeto
                //Podemos mover la tetera en cualquier posicion con las letras del teclado, y la cámara lo seguirá 
                glu.gluLookAt(t.x+3+Teclado.getTrasladaTeteraX(),t.y+ Teclado.getTrasladaTeteraY(),t.z+3+Teclado.getTrasladaTeteraZ(),t.x+Teclado.getTrasladaTeteraX(),t.y+Teclado.getTrasladaTeteraY(),t.z+Teclado.getTrasladaTeteraZ(),0,1,0);
               
             }
              if(ncam==6){
               
                  
                glu.gluLookAt(t.x+2,t.y+2+Teclado.getTrasladaY(),t.z+2+Teclado.getTrasladaZ(),t.x,t.y,t.z,0,1,0);}
